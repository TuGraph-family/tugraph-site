export default {
  ...
  'home.banner.title': '性能第一的TuGraph图数据库',
  'home.banner.mobileTitle': '性能第一的图数据库',
  'home.banner.desc': '免费试用',
  'home.banner.desc1': '3分钟云端部署',
  'home.banner.desc2': '最长30天费用全免',
  'home.banner.desc3': '更多试用权益',
  'home.banner.desc4': '基准性能测试世界第一的图数据库（来源: LDBC）',
  'home.banner.registrationTime': '报名时间 : 2023.03.05 - 2023.04.02',
  'home.banner.weChat': '微信公众号',
  'home.banner.weChatDesc': '扫码了解更资讯',
  'home.banner.btnText': '查看详情',

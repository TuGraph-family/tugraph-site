export default {
  ...
  'home.case3.desc0': '电网分析、供应链管理',
  'home.case3.desc1': '设备管理、故障诊断',
  'home.case4.title': '电信领域',
  'home.case4.desc0': '防骚扰、电信诈骗防范、运营商经营',
  'home.case4.desc1': '分析、设备维护',
  ...
  'demo.type1': '互联网',
  'demo.title2': '隐私保护、数据治理及数据血缘：',
  'demo.desc2':
    '用图模型找到数据之间的关联关系，更容易分析数据流转过程，建立数据链路，进而梳理数据依赖、权限并提升质量。',
  'demo.type2': '社 交',
  ...
  'demo.example.challenge4':
    '一些企业通过开具虚假发票来减少缴税成本或者获取不正的利益，其中变票是经常出现的虚假开票行为之一，即开具与实际经营业务情况不符的发票。用户基于某国外开源图数据库只能进行部分数据分析，数据覆盖率低，准确率低；变票分析的过程中无法快速获取企业间的发票开具关系；无法直观快速进行研判。',
  'demo.example.solution4':
    '通过TuGraph构建企业之间的票据关系网，利用图计算技术打造票据主题研判系统，挖掘企业间的票流关系，标识变票风险企业，进行辅助研判分析。',
  'demo.example.profit4':
    '提高分析数据的规模、范围，提升分析精准度。采用TuGraph作为底层变票分析存储、查询、分析的底座，复杂查询性能较用户原有某开源产品提升两个数量级。',
  'demo.example.title5': '建立全域实时会员关系网络，助力用户增长',
  'demo.example.challenge5':
    '传统营销方式（如手机号等）体验差、转化率低，逐渐被淘汰。特别是拓展下沉市场、两端人群，常规渠道难以触达。对于变化的会员关系网络，需要持续更新以保证网络准确。',
  ...
  'demo.example.profit5':
    '蚂蚁森林逾5亿用户的好友互动、新春五福的关系推荐，都采用了蚂蚁图数据库技术，实现毫秒级的拉新、推荐和同步。',
  ...
  'demo.example.solution6':
    '利用图计算技术，将业务、数据、任务、输入、输出、负责人等对象抽象为点、边，构建数据资产图谱，支撑智能化的数据血缘管理。',

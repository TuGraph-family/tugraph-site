...
<div class="ICDM-banner" style="max-width: 500px">
    ...
    <br>
    <strong style="color:#fff;">Contestants are requested to name the submitted txt file as "{team name}.txt", for example "Ma Xiaoan.txt"</strong>
    </div>
</div>
...
| Ranking | Participants | Teams | ARI Scores | Best Score Submission Date |
|:--------------------:|:----------------------:|:----------------------:|:--------------------:|:----------------------:|
| 1 |Yongwei Tang |  - | 0.2864 | 2023-08-21 |
